        ...
        try:
            ...
            if not users_with_credentials and len(user_state) > 0:
                ...
                for user_id in user_state:
                    ...
                    test_reminder_message = f"[TEST MODE] It's time to order {test_meal_type}! I found two options for you: Chipotle and Sweetgreen. Would you like to see the menus?"
    ...
    def send_welcome_reminder():
        ...
        try:
            ...
            if lunch_meetings:
                ...
                welcome_message = f"It's 11:00 AM, I noticed you have {meeting_desc}. Time to order food! I found two options for you: Chipotle and Sweetgreen. Would you like to see the menus?"
